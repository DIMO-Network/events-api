...
docker: deps
	@docker build -f ./resources/docker/Dockerfile . -t dimozone/events-api:$(VER_CUT)
	@docker tag dimozone/events-api:$(VER_CUT) dimozone/events-api:latest

docker-cgo: deps
	@docker build -f ./resources/docker/Dockerfile.cgo . -t dimozone/events-api:$(VER_CUT)-cgo
	@docker tag dimozone/events-api:$(VER_CUT)-cgo dimozone/events-api:latest-cgo
...
test: $(APPS)
	...
	@$(PATHINSTBIN)/events-api test ./config/test/...
